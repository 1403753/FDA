...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{X} \PY{o}{=} \PY{n}{data}\PY{o}{.}\PY{n}{iloc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{:}\PY{n+nb}{len}\PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{columns}\PY{p}{)}\PY{p}{]}\PY{p}{;}
...
leads to a better model (although, the 'economy' factor is still too
high in the second VIF table above). Like the 'economy' variable, the
'GDP per capita' and 'internet access population' variables highly
...
linear model fits best for the 'economy' factor, but for the other two
other models should work better.\newline
